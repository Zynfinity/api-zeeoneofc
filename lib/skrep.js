...
exports.zerochan = (query) => {
	return new Promise((resolve,reject) => {
      ...
      const id = [];
        ...
        if(!$(b).attr('href').startsWith('https://static.zerochan.net/')){
				judul.push($(b).attr('href'))
        }
			})
...
exports.happymoddl = (link) => {
	return new Promise((resolve,reject) => {
      ...
      $('body > div > div.container-left > section:nth-child(1) > div:nth-child(10) > div:nth-child(3) > div > p > a').each(function(a, b) {
        deta = $(b).text();
        jlink.push(deta)
...
exports.infohoax = async() => {
  return new Promise((resolve, reject) => {
    axios.get(`https://turnbackhoax.id/`)
    .then((data) => {
      ...
      const upload = [];
      const author = [];
      $('#main-content > article > div > header > h3 > a').each(function(a, b) {
        deta = $(b).text();
        judul.push(deta.replace(/\t|\n/g, ''))
      })
      $('#main-content > article > div > header > h3 > a').each(function(a, b) {
        link.push($(b).attr('href'))
      })
      $('#main-content > article > figure > a > img').each(function(a, b) {
        thumb.push($(b).attr('src'))
      })
      $('#main-content > article > div > header > div > span.mh-meta-date.updated').each(function(a, b) {
        deta = $(b).text();
        upload.push(deta)
      })
      $('#main-content > article > div > header > div > span.mh-meta-author.author.vcard > a').each(function(a, b) {
        deta = $(b).text();
        author.push(deta)
      })
      for(let i=0; i<judul.length; i++){
...
exports.igstalk = async(username) => {
    ...
    let {data} = await axios('https://www.instagram.com/'+username+'/?__a=1', {
        ...
        'cookie': 'ig_did=EA7DC112-2D2C-45CF-9B49-911C077DC4CB; mid=X93bwQAEAAHzC4NGbr6c9GYzt-3Y; ig_nrcb=1; csrftoken=xgGTxDVEDFhrFmD2EOj2eJIujNZy0Pc3; ds_user_id=8779859677; sessionid=8779859677%3AwZZLTcEATX3gC9%3A1; shbid="10275\0548779859677\0541663290382:01f7d0639a2cd9182f2cf3cfb1bd9d894226e5aa11a07df81eaa795503c369698346fd6e"; shbts="1631754382\0548779859677\0541663290382:01f7bbdb647df59fba613782b0c88e4b43e869fd3e3fbefbe77dd00f1c4ea1c429af0b06"; rur="EAG\0548779859677\0541663339232:01f7da5c42adbc5c5ba39007505205422bf1143614dde576c6bde777bca5df3a6fa29c61"',
        }
    })
